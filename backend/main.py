...
# ── App ────────────────────────────────────────────────────────────────────
app = FastAPI(
    title="Multi-Language Coding Test Platform",
    version="2.0.0",
    docs_url="/api/docs",
    redoc_url="/api/redoc",
...
def runtimes():
    """Which language toolchains are installed on this host (python/gcc/g++/javac)."""
    from code_runner import detect_runtimes
