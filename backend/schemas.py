...
class ProblemCreate(BaseModel):
    ...
    starter_code_map: Optional[dict] = None        # optional per-language starters
    allowed_languages: Optional[List[str]] = None  # null/empty → all four allowed
...
class ProblemResponse(BaseModel):
    ...
    topics: Optional[str]
    starter_code: Optional[str] = None
    starter_code_map: Optional[dict] = None
