...
print("\n── Seeding users ──────────────────────────────────────────────────")
admin   = upsert_user("admin",    "admin@codearena.dev",    "Platform Admin",  "Admin@123",   "admin",   "#6366f1")
student1= upsert_user("student1", "student1@codearena.dev", "Alice Johnson",   "Student@123", "student", "#10b981")
student2= upsert_user("student2", "student2@codearena.dev", "Bob Smith",       "Student@123", "student", "#06b6d4")
student3= upsert_user("student3", "student3@codearena.dev", "Carol Williams",  "Student@123", "student", "#8b5cf6")
