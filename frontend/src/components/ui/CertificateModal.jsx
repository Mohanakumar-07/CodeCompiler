...
export default function CertificateModal({ open, onClose, name, solved, avgScore }) {
  ...
  const fileBase = `CodeArena_Certificate_${safeName.replace(/\s+/g, '_')}`
      ...
      <div className="w-full max-w-4xl" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="rounded-xl overflow-hidden shadow-lg" style={{ boxShadow: '0 20px 60px rgba(0,0,0,0.5)' }}>
          <svg ref={svgRef} viewBox={`0 0 ${W} ${H}`} width="100%" xmlns="http://www.w3.org/2000/svg" style={{ display: 'block' }}>
            ...
            <text x={W / 2} y="178" textAnchor="middle" fontFamily="Arial, sans-serif" fontSize="13" letterSpacing="4" fill="#76726B">CODEARENA · CERTIFICATE OF ACHIEVEMENT</text>
            ...
            <text x={W / 2} y="420" textAnchor="middle" fontFamily="Arial, sans-serif" fontSize="15" fill="#3D3B38">has successfully demonstrated coding proficiency on the CodeArena platform.</text>
            ...
            <text x="205" y="606" textAnchor="middle" fontFamily="Georgia, serif" fontStyle="italic" fontSize="18" fill="#171716">CodeArena</text>
