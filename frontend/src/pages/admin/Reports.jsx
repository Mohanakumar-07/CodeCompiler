...
import { Search, Eye, CheckCircle, XCircle, Clock, Code2, Download, Sparkles, MessageSquare, AlertTriangle } from 'lucide-react'
    ...
    <div className="space-y-5 animate-fade-in">
      ...
      <div className="flex items-center gap-3 flex-wrap">
        ...
        <button
          ...
          onClick={() => downloadFile(`/reports/export${mode ? `?mode=${mode}` : ''}`, 'codearena_gradebook.xlsx').catch(() => toast.error('Export failed'))}
        >
    ...
    <div className="space-y-5">
      ...
      {r.tab_switches > 0 && (
        <div className="flex items-center gap-2 p-3 rounded-lg border border-line text-sm"
          ...
          <AlertTriangle size={14} className="inline-block flex-shrink-0" /> Tab switches detected: {r.tab_switches}
        </div>
      )}
